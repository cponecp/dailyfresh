...
class GoodsType(BaseModel):
    ...
    logo = models.CharField(max_length=20, verbose_name='标识') # logo指雪碧图当中的图片 利用class名来标识位置
    image = models.ImageField(upload_to='type', verbose_name='商品类型图片')  # upload_to='type' 已经改写了存储机制 不会生效
